...
if ! exists ('g:visual_studio_quickfix_errorformat_cpp')
	" 1>.\MSearchRadioControl.cpp(26) : error C3646: 'kadfj' : unknown override specifier
    let g:visual_studio_quickfix_errorformat_cpp = '1>\ %#%f(%l)\ :\ %m'
endif
...
function! DTEDebugSolution()
    let &errorfile = g:visual_studio_output
    call <Sid>DTEExec ('dte_debug_solution', &errorfile, g:visual_studio_write_before_build)
endfunction
...
if has('gui') && ( ! exists('g:visual_studio_menu') || g:visual_studio_menu != 0 )
    ...
    amenu <silent> &VisualStudio.&Debug\ Solution :call DTEDebugSolution()<cr>
